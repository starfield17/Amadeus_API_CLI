        ...
        while True:
            try:
                ...
                try:
                    ...
                    # 标记是否已经显示过reasoning panel
                    reasoning_panel_shown = False
                    ...
                    for chunk in response:
                        ...
                        if chunk.choices[0].delta.reasoning_content is not None:
                            ...
                            # 当有新的reasoning内容时，如果还没显示panel就显示
                            if not reasoning_panel_shown:
                                self.ui.display_message("")  # 空行
